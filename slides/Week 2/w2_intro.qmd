...
- 2 semester sequence to conduct an independent data science project
  - Fall: seminar on research skills, advisor relationship, data access, and a feasible project plan
  - Spring: complete and advance your thesis, find a letter writer/reference, and build your network
